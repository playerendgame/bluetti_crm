<template>
    <b-modal id="updateRegion" :hide-footer="true" title="Update Region">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
...
export default{
    ...
    methods: {
        update() {
            ...
            Swal.fire({
                title: "Update",
                text: "Are you sure you want to update Region?",
                icon: "warning",
                ...
                preConfirm: function() {
                    return new Promise(function (resolve) {
                        axios({
                            method: "post",
                            url: "/ajax/admin/dropdown/region/update",
                            data: self.region,
                        ...
                        .then(function(response) {
                            if (response.data.success) {
                                Swal.fire({
                                    ...
                                    self.status = 0;
                                    self.$bvModal.hide("updateRegion");

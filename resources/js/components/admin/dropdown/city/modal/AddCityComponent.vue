<template>
    <b-modal id="addCity" :hide-footer="true" title="Update City">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
...
export default{
    ...
    methods:{
        ...
        create() {
            ...
            Swal.fire({
                title: "Update",
                text: "Are you sure you want to add City??",
                icon: "warning",
                ...
                preConfirm: function() {
                    return new Promise(function (resolve) {
                        axios({
                            method: "post",
                            url: "/ajax/admin/dropdown/city/create",
                            data: self.city,

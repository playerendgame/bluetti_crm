<template>
    <b-modal id="addProvince" :hide-footer="true" title="Add Province">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
...
export default{
    ...
    methods:{
        ...
        create() {
            ...
            Swal.fire({
                title: "Update",
                text: "Are you sure you want to add Province??",
                icon: "warning",
                ...
                preConfirm: function() {
                    return new Promise(function (resolve) {
                        axios({
                            method: "post",
                            url: "/ajax/admin/dropdown/province/create",
                            data: self.province,
